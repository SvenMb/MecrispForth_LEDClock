\ this is modified by Sven Muehlberg for Bluepill usage
\ definitions already done in other places are removed
\ init is done in board.fs
\ ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
\ Mecrisp - Muehlberg
  ...
  bl     h, char - h, bl     h, char M h, char u h, char e h, char h h,
  char l h, char b h, char e h, char r h, char g h,

create usb:product 
\ Forth Serial Port
\ Forth LEDClock 01
  36 c, 3 c,  \ USB_STRING_DESCRIPTOR_TYPE,
  char F h, char o h, char r h, char t h, char h h, bl     h, char L h,
  char E h, char D h, char C h, char l h, char o h, char c h, char k h,
  bl     h, char 0 h, char 1 h,
